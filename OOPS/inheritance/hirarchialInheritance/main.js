...
class  creditAccUser extends  Bank{
    #accType; 
     constructor(bankUser)  {
         super(bankUser.getUsername(),bankUser.getBalance())
         this.#accType ="credit"
...
let newCreditUser = new creditAccUser(user1 ) // constructore  expect Bank accout user as an object 
console.log(newDebitUser.getUsername());
console.log(newDebitUser.getAccount());
console.log(newDebitUser.getAccountType());


console.log(newCreditUser.getAccountType());